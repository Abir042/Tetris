...
package org.nirvana.game.activities;

import org.nirvana.game.BuildConfig;
import org.nirvana.game.R;
import org.nirvana.game.components.GameState;
import org.nirvana.game.components.Sound;
import org.nirvana.game.db.HighscoreOpenHelper;
import org.nirvana.game.db.ScoreDataSource;
...
public class MainActivity extends ListActivity {
	 ...
	 */
	public static final String PLAYERNAME_KEY = "org.nirvana.game.activities.playername";
	
	/** This key is used to access the player name, which is returned as an Intent from the gameactivity upon completion (gameover).
	 *  The Package Prefix is mandatory for Intent data
	 */
	public static final String SCORE_KEY = "org.nirvana.game.activities.score";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		StartAppSDK.init(this,"210989161");
